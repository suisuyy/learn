...
#install packages
sudo apt update
sudo apt install -y fonts-wqy-zenhei openssh-server ntfs-3g iputils-ping iperf3 curl wget git vim bash-completion screen htop w3m aria2 p7zip unrar rsync sshfs tinyproxy ttyd
