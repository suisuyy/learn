# toc
- [toc](#toc)
- [nice file path](#nice-file-path)
- [useage](#useage)
- [auto task](#auto-task)
  - [auto at gui login](#auto-at-gui-login)
- [bash](#bash)
- [backup](#backup)
- [benchmark](#benchmark)
- [cat and heredoc](#cat-and-heredoc)
- [cron](#cron)
- [disk](#disk)
...
- [screen](#screen)
- [security](#security)
- [system and kernel](#system-and-kernel)
...
@reboot screen -dm bash -c 'df;  bash'
